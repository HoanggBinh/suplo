...
const fullText1 = splitLines("Gửi Súp Lơ <3", 3);
const fullText2 = splitLines("Mong Sap Súp Lơ Luôn Cười Tươi Và Vui Vẻ Đừng Buồn Nhiều Nữa Nhé", 3);
const fullText3 = splitLines("Valentine Vui Và Hạnh Phúc Nhé Iu Iu :3", 3);
